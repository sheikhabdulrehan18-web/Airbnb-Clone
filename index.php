...
<head>
    ...
    <title>Airbnb Clone - Hire your dream home</title>
...
<body>
    ...
    <header class="hero">
        <h1 class="fade-in">Find your next adventure.</h1>
        <div class="search-container fade-in">
            <form action="properties.php" method="GET" class="search-bar">
                ...
                <button type="submit" class="search-btn">
                    <svg viewBox="0 0 32 32" width="16" height="16" fill="white"><path d="M13 24a11 11 0 1 0 0-22 11 11 0 0 0 0 22zm8-3l9 9"></path></svg>
                </button>
            </form>
        </div>
    </header>
    ...
    <main class="container">
        <h2 style="margin-bottom: 2rem;">Explore nearby</h2>
        <div class="grid">
            <?php
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <div class="stroke-card">
                        ...
                        <div class="card-content">
                            ...
                            <a href="book.php?id='.$row['id'].'" class="btn-primary" style="display:inline-block; margin-top:1rem; text-decoration:none;">Book Now</a>
                        </div>
                    </div>';
                }
            } else {
